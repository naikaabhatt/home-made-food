...
import PersonelInfo from '../Screens/Personelnfo'
...
class Profile extends React.Component{
    ...
    handler(e)
    {
            ...
            this.props.navigation.navigate('PersoneInfo',{token:this.props.route.params.tk});
    }
    addresshandler(e)
    {
        this.props.navigation.navigate('AddressInfo',{token:this.props.route.params.tk});
    }
